...
export const updateDelivery = async (
  ...
  await pool
    ...
    .input("Status", delivery.Status)
    .query(
      "UPDATE Deliveries SET DeliveryDate = @DeliveryDate, DeliveryAddress=@DeliveryAdrress, CourierName=@CourierName, CourierContact=@CourierContact, Status = @Status WHERE DeliveryID = @DeliveryID",
    );
